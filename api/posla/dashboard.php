...
function build_op_monitoring_delegation(PDO $pdo): array
{
    $opPublicUrl = (string)(get_posla_setting($pdo, 'codex_ops_public_url') ?: '');
...
$releaseMonitoring = build_op_monitoring_delegation($pdo);
...
json_response([
    ...
    'releaseMonitoring' => $releaseMonitoring,
]);
