/**
 * POSLA Handy PWA 登録スクリプト
 *
 * 各 admin HTML の <body> 末尾に以下 1 行を追加:
 *   <script src="/public/handy/pwa-register.js"></script>
 *
 * scope: /public/handy/ に固定。/customer/ や /api/ には絶対干渉しない。
 *
...
(function () {
  ...
  if (location.pathname.indexOf('/public/handy/') === -1
