...
65. migration-p119d-zh-hant-encoding-fix.sql — ui_translations zh-Hant の checkout 系キーを正しい繁体字で上書き（P1-19d、2026-04-29 現物確認）
66. migration-p133-collation-fix.sql — daily_recommendations/call_alerts/satisfaction_ratings を utf8mb4_unicode_ci に CONVERT（B-2026-04-08-09、MySQL 8.0 デフォルト utf8mb4_0900_ai_ci からの混入修正）
67. migration-self-menu-attributes.sql — menu_templates/store_local_items に `spice_level`, `is_vegetarian`, `is_kids_friendly`, `is_quick_serve`, `prep_time_min` を追加
68. migration-self-menu-i18n.sql — セルフメニュー検索・絞り込み・代替提案・追加提案の ui_translations キーを5言語で追加
69. migration-self-menu-guidance.sql — `menu_alternatives` 新設 + アレルギー確認/オプション明確化/送信前確認/併売提案の ui_translations キーを5言語で追加
```
