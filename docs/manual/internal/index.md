...
features:
  ...
  - title: Cell配備運用
    ...
    link: /internal/11-cell-deployment
  - title: POSLA全体リファレンス
    details: アーキテクチャ、API、DB、テナント境界、管理画面、予約、テイクアウト、シフト、決済、AI、PWA、監視、スモークテストを横断整理
    link: /internal/00-complete-reference
  - title: 運営編(POSLA社内)
    details: POSLA管理画面・テナントオンボーディング・Stripe Billing/Connect・システム運用・トラブル対応・運用監視
    link: /internal/01-posla-admin
  - title: 顧客向け機能ガイド(全26章)
    details: 管理画面、メニュー、レジ、ハンディ、KDS、シフト、予約、テイクアウト、店舗設定まで、顧客へ説明するための操作ガイド
    link: /tenant/01-introduction
  - title: 予約・テイクアウト実装
    details: 予約とテイクアウトのAPI、DB、通知、予約金、キャンセル待ち、梱包、SLA、返金連動、未実装範囲を確認
    link: /internal/14-reservation-takeout-ops
