...
| `E3042` | `FORBIDDEN_ORIGIN` | 403 | リクエスト元が許可されていません | 2 | api/lib/auth.php |
...
| `E3018` | `INVALID_SIGNATURE` | 400 | Webhook署名の検証に失敗しました | 2 | api/line/webhook.php, api/subscription/webhook.php |
...
| `E3043` | `PIN_RATE_LIMITED` | 429 | PIN の試行回数が上限に達しました。10分後に再度お試しください。 | 1 | api/store/process-payment.php |
...
| `E3028` | `SESSION_REVOKED` | 401 | POSLA管理者セッションが無効化されました。再ログインしてください。 | 2 | api/lib/auth.php, api/posla/auth-helper.php |
...
| `E1008` | `EMPTY_BODY` | 400 | リクエストボディが空です | 3 | api/lib/response.php, api/line/webhook.php, api/subscription/webhook.php |
...
| `E1013` | `GENERATE_FAILED` | 500 | 領収書の作成に失敗しました | 1 | api/store/receipt.php |
| `E1014` | `IMPORT_FAILED` | 500 | インポートに失敗しました | 8 | api/owner/ingredients-csv.php, api/owner/menu-csv.php, api/owner/recipes-csv.php …他5 |
...
| `E1029` | `RATE_LIMIT` | 429 | しばらく時間をおいて再度お試しください | 1 | api/customer/takeout-line-token.php |
| `E1021` | `RATE_LIMITED` | 429 | ログイン試行回数の上限に達しました。5分後に再度お試しください。 | 2 | api/lib/rate-limiter.php, api/posla/login.php |
| `E1022` | `SAVE_FAILED` | 500 | ファイルの保存に失敗しました | 2 | api/owner/upload-image.php, api/store/upload-image.php |
| `E1023` | `SEAT_FAILED` | 500 | 着席処理に失敗しました | 1 | api/store/reservation-seat.php |
...
| `E4003` | `CUSTOMER_NOT_FOUND` | 404 | 該当の顧客が見つかりません (reservation_customer_id または store_id + customer_phone を確認してください) | 2 | api/owner/line-link-tokens.php, api/store/reservation-customers.php |
| `E4004` | `ITEM_NOT_FOUND` | 404 | 品目が見つかりません | 2 | api/customer/satisfaction-rating.php, api/kds/update-item-status.php |
| `E4005` | `NOT_FOUND` | 404 | メニューが見つかりません | 81 | api/connect/disconnect.php, api/customer/menu.php, api/customer/reservation-cancel.php …他48 |
...
| `E4010` | `PLAN_NOT_FOUND` | 404 | プランが見つかりません | 2 | api/store/table-sessions.php |
...
| `E9029` | `ALREADY_UNLINKED` | 409 | この link は既に解除済です | 1 | api/owner/line-customer-links.php |
...
| `E9023` | `LINE_NOT_CONFIGURED` | 400 | この店舗では LINE 連携が有効化されていません | 2 | api/customer/takeout-line-token.php |
| `E9013` | `NOT_AVAILABLE` | 400 | 事前チェックインできない状態です | 1 | api/customer/reservation-precheckin.php |
| `E9024` | `NOT_CONFIGURED` | 503 | LINE ひも付けトークン用マイグレーション (Phase 2A-2) が未適用です | 7 | api/customer/takeout-line-token.php, api/line/webhook.php, api/owner/line-customer-links.php …他2 |
| `E9025` | `ORDER_TERMINAL` | 400 | この注文はすでに完了しているため、LINE連携は利用できません | 1 | api/customer/takeout-line-token.php |
...
| `E9028` | `REVOKE_FAILED` | 404 | 失効できませんでした (既使用 / 既失効 / 存在しない可能性) | 1 | api/owner/line-link-tokens.php |
...
| `E9026` | `TAKEOUT_READY_DISABLED` | 400 | この店舗では準備完了 LINE 通知が有効化されていません | 1 | api/customer/takeout-line-token.php |
| `E9027` | `TOKEN_ISSUE_FAILED` | 500 | トークン発行に失敗しました | 4 | api/customer/takeout-line-token.php, api/owner/line-link-tokens.php |
| `E9030` | `UNLINK_FAILED` | 500 | 解除に失敗しました | 1 | api/owner/line-customer-links.php |
...
| `E5020` | `COURSE_SET` | 409 | コースセッションにはプランを後付けできません | 1 | api/store/table-sessions.php |
...
| `E5019` | `PLAN_ALREADY_SET` | 409 | このセッションには既にプランが設定されています | 1 | api/store/table-sessions.php |
| `E5018` | `SESSION_CLOSED` | 409 | このセッションは既に終了しています | 1 | api/store/table-sessions.php |
...
| `E2008` | `INVALID_DATE` | 400 | 日付形式が不正です | 20 | api/customer/reservation-availability.php, api/customer/takeout-orders.php, api/owner/shift/unified-view.php …他9 |
...
| `E2013` | `INVALID_INPUT` | 400 | mappings 配列が必要です | 11 | api/owner/line-settings.php, api/smaregi/store-mapping.php, api/store/shift/apply-ai-suggestions.php |
| `E2014` | `INVALID_JSON` | 400 | リクエストのJSONが不正です | 2 | api/lib/response.php, api/line/webhook.php |
...
| `E2017` | `INVALID_PARTY_SIZE` | 400 | 人数が範囲外です | 7 | api/customer/reservation-availability.php, api/customer/reservation-create.php, api/customer/reservation-update.php …他1 |
...
| `E2039` | `MISSING_ID` | 400 | idが必要です | 41 | api/customer/reservation-detail.php, api/owner/categories.php, api/owner/ingredients.php …他23 |
...
| `E2042` | `MISSING_ORDER` | 400 | order_idが必要です | 4 | api/customer/takeout-line-token.php, api/customer/takeout-orders.php, api/customer/takeout-payment.php …他1 |
...
| `E2048` | `MISSING_PHONE` | 400 | 電話番号が必要です | 3 | api/customer/takeout-line-token.php, api/customer/takeout-orders.php |
...
| `E2079` | `MISSING_TENANT` | 400 | tenant は必須です | 1 | api/line/webhook.php |
...
| `E2060` | `NO_CHANGES` | 400 | 更新項目がありません | 4 | api/customer/reservation-update.php, api/owner/line-settings.php, api/posla/settings.php …他1 |
